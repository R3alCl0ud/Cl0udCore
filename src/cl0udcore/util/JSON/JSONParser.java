...
public abstract class JSONParser
{
  ...
  private static final Reader niller = null;
  private static final ContainerFactory Yypar = null;
  private LinkedList handlerStatusStack;
  private Yylex lexer = new Yylex(niller);
    ...
    try
    {
      do
      {
        ...
        case 4: 
          ...
          case 3: 
            statusStack.removeFirst();
            String key1 = (String)valueStack.removeFirst();
            Map parent1 = (Map)valueStack.getFirst();
            List newArray = createArrayContainer(containerFactory);
            parent1.put(key1, newArray);
            this.status = 3;
            statusStack.addFirst(new Integer(this.status));
        ...
        case 3: 
          ...
          case 4: 
            ...
            break;
          case 1: 
            List val1 = (List)valueStack.getFirst();
            Map newObject = createObjectContainer(containerFactory);
            val1.add(newObject);
            this.status = 2;
            statusStack.addFirst(new Integer(this.status));
